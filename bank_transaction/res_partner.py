...
class res_partner(osv.osv):
    ...
    _columns = {'payment_type_default': fields.one2many('partner.payment.type.default', 'partner_id', 'Payment Type Default'),
...
class partner_payment_type_default(osv.osv):
    ...
    _columns = {'company_id': fields.many2one('res.company', 'Company', required=True),
     'payment_type': fields.many2one('payment.type', 'Payment Type', required=True),
