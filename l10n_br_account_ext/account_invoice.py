# Embedded file name: /opt/openerp/producao/addons-extension/l10n_br_account_ext/account_invoice.py
...
class account_invoice(orm.Model):
    ...
    _columns = {'immediate_pay_amount': fields.float('Amount', digits_compute=dp.get_precision('Account'), readonly=True, states={'draft': [('readonly', False)]}),
    ...
    def immediate_payment(self, cr, uid, ids, context = None):
        ...
        for rec_account_invoice in self.browse(cr, uid, ids, context=context):
            ...
            account_voucher_vals = {'type': 'receipt',
...
class account_invoice_tax(osv.osv):
    ...
    _columns = {'tax_retain': fields.float('Tax Retain', digits_compute=dp.get_precision('Account'), readonly=True)}
