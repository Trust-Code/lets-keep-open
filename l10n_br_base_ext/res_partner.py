# Embedded file name: /opt/openerp/homolog/addons-extension/l10n_br_base_ext/res_partner.py
from openerp.osv import fields, osv

class res_partner(osv.osv):
    _inherit = 'res.partner'
    _columns = {'parent_id': fields.many2one('res.partner', 'Related Company')}
    ...
    _defaults = {'property_account_payable': _get_account_payable,
